      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <motion.div
          ...
          className={`relative max-w-sm mx-auto md:mx-0 rounded-2xl overflow-hidden border p-3 transition-colors duration-500 ${
            isDarkMode ? 'border-zinc-800 bg-zinc-950' : 'border-gray-200 bg-white shadow-md'
          }`}
        >
          <div className={`aspect-[3/4] rounded-xl flex items-center justify-center transition-colors duration-500 ${
            isDarkMode ? 'bg-zinc-900 text-zinc-600' : 'bg-gray-100 text-zinc-400'
          }`}>
        ...
        >
          <h3 className={`text-xl md:text-2xl font-bold mb-4 transition-colors duration-500 ${
            ...
            Hi, I&apos;m <span className="text-rose-500">{profile.name}</span> – A
            MERN Stack Developer based in Egypt.
          </h3>
          ...
          <div className="grid grid-cols-3 gap-4 mb-8">
            <div className={`p-4 rounded-xl border text-center transition-all duration-500 ${
              ...
              <span className={`text-xs uppercase tracking-wider font-medium transition-colors duration-500 ${
